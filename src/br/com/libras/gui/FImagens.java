...
public class FImagens extends javax.swing.JFrame {
    ...
    private void jButtonSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSairActionPerformed
    	int resposta = JOptionPane.showConfirmDialog(null, "Você Deseja Realmente Sair ?", "Fechar Aplicativo.", JOptionPane.YES_NO_OPTION);
    	if (resposta == 0) {
    		dispose();
    	}
    ...
    private void jButtonSobreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSobreActionPerformed
        // TODO add your handling code here:
    	JOptionPane.showMessageDialog(null, "Versão 1.0 do Aplicativo de libras Paraense \n"
    			+ "Este aplicativo visa ajudar nos entendimento de girias, \n"
    			+ "comidas tipicas e locais que os paraenses conhecem no seu dia a dia ");
